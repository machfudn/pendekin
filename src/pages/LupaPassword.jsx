  ...
  const submitReset = async e => {
    ...
    try {
      ...
      if (error) {
        ...
        toast.success('Link reset password telah dikirim ke email Anda. Silakan periksa kotak masuk.');
        setEmail('');
      }
    } catch (err) {
  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-800'>
      <div className='p-8 mx-auto bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg w-full max-w-md mt-10'>
        <header className='text-3xl font-bold text-center mb-6 text-gray-800 dark:text-white'>Lupa Password</header>
