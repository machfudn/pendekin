      ...
      <div className='mx-auto px-4 py-6'>
        <div className='bg-white shadow-md rounded-lg p-6 dark:bg-gray-900'>
          ...
          <p className='text-black dark:text-white text-justify mb-2'>
            Pendekin adalah layanan pemendek URL yang memungkinkan pengguna untuk membuat tautan pendek dari URL panjang mereka. Layanan ini
          ...
          <a
            ...
            href='https://github.com/machfudin37'
            target='_blank'
          ...
          <a
            className='flex gap-2 items-center hover:text-blue-500 dark:hover:text-blue-500 
             text-black dark:text-white
             transition-colors'
            href='https://kontak-saya.pages.dev/'
            target='_blank'
            rel='noopener noreferrer'>
            <IconEmail />
            Kontak Saya
